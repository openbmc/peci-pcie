...
#endif
#ifdef DEBUG
        std::cout << "Request: bus " << bus << " dev " << dev << " func "
...
#ifdef DEBUG
    std::cout << "peciAvailableCheck " << peciAvailable << " " << lastPECIState
              << " " << peci_pcie::abortScan << std::endl;
#endif
...
#ifdef DEBUG
        std::cout << "Scanning in 60 seconds\n";
#endif
